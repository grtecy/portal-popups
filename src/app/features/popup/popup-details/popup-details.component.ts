...
export class PopupDetailsComponent implements OnInit {
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<PopupDetailsComponent>,
  ...
  model = new ItemRequest('', '', '2021-01-01', ['auto_fill', 'dummy2'], [], []);

  submitted = false;

  newItemRequest() {
    this.model = new ItemRequest('', '', '2021-01-01', ['auto_fill', 'dummy2'], [], []);
  }
  ...
  ngOnInit() {
    ...
    this.registerForm = this.formBuilder.group({
      ...
      contactsReviews: ['', [Validators.required]],
      filesUploaded: [''],
      imagesUploaded: ['']
    });
